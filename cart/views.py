...
class CartAPIView(APIView):
    ...
    def post(self, request):
        ...
        return Response({"errmsg": f"You have successfully added {[g.goods_name for g in the_goods]} in the cart!", "cart_total": cart_total},
    ...
    def get(self, request):
        ...
        final_discount = self.discount_oper(invoice_info, goods_total_amount, has_shoes, has_jacket, top_outfit_amount, discount, shoes_num)
        ...
        return Response({"errmsg": invoice_info}, status=status.HTTP_200_OK)
